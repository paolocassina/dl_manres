...
if __name__ == "__main__":
    ...
    parser.add_argument("--embedding_file", type=str, default="../data/embs/bert-base-uncased_2_verb_embeddings.pkl",
                        help="Path to the embeddings file")
    parser.add_argument("--label_file", type=str, default="../data/verbs/manres_lemma.csv", help="Path to the labels file")
    parser.add_argument("--pca", action="store_true", help="Apply PCA reduction to embeddings before probing")
